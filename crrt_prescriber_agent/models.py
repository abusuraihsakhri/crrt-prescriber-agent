"""
Clinical Data Models & Enums for CRRT-Mind: Continuous Renal Replacement Therapy Effluent & Citrate Anticoagulation Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "KDIGO 2012 AKI & CRRT Practice Guidelines"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
